...
public class Main {
    ...
    public static void announcementTest(){
        return;
    }
    ...
    // announcementController.sendPrivateAnnouncement(123, "Test Announcement");
    // announcementController.sendPrivateShowTimeAnnouncement(1, "Black panter early access, get tix now", "2004-11-03", 1); // should only return an error because showtime isnt there
    // announcementController.sendPublicAnnouncement(2, "Hello gang");
